...
#define CONFIG_SYS_VIDEO_LOGO_MAX_SIZE ((800 * 480 * 4) + (1 << 12))
#define CONFIG_CONSOLE_SCROLL_LINES 1
*/

/* ILI9325_LCD */
#define CONFIG_S5PV210_ILI9325_LCD
/*
LCD video settings 
*/
#define CONFIG_CFB_CONSOLE                
//Enables console device for a color framebuffer
#define CONFIG_SYS_VIDEO_LOGO_MAX_SIZE  (800*480+1024+100)   /* 100 = slack */
...
//#define LCD_VIDEO_ADDR        (0x24000000)    //根据开发板的内存地址配置  
#define LCD_VIDEO_ADDR        (0x58000000)//(0x3fe79000)    //根据开发板的内存地址配置  

/* #define LCD_VIDEO_BACKGROUND  */ 
#define CONFIG_VGA_AS_SINGLE_DEVICE
#define DEBUG_CFB_CONSOLE
#if defined(LCD_VIDEO_BACKGROUND) 
#define LCD_VIDEO_BACKGROUND_ADDR  (0x25000000)
